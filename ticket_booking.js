document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById("booking-form").addEventListener("submit", async (e) => {
    ...
    let messageDiv = document.getElementById("booking_message");
    if(!messageDiv){
        const div = document.createElement("div");
        div.id = "booking_message";
        div.className = "p-2 rounded my-2 text-center";
    ...
    if(data.success){
        ...
        messageDiv.style.backgroundColor = "#d1fae5"; // green
        messageDiv.style.color = "#065f46";
        e.target.reset();
        document.getElementById("pricing_section").classList.add("hidden");
        document.getElementById("passenger_inputs").innerHTML = "";
    }else{
        messageDiv.textContent = data.message;
        messageDiv.style.backgroundColor = "#fee2e2"; // red
