...
<head>
  ...
  <title>Musafir - Your Travel Companion</title>
...
<body class="text-gray-800 relative">
  ...
  <section class="hero flex items-center justify-center relative">
    ...
    <div class="relative z-10 text-center text-white px-6">
      <h1 class="text-6xl font-extrabold mb-6 text-shadow">Welcome to Musafir</h1>
  ...
  <section id="services" class="py-16 bg-gray-100">
    <div class="container mx-auto">
      ...
      <p class="text-lg text-gray-700 text-center mb-12">
        At Musafir, we offer a range of services to make your travel experience smooth, stress-free, and enjoyable.
      </p>
